#ifndef __OUTPUT_PARSE_TEST_HPP__
#define __OUTPUT_PARSE_TEST_HPP__

#include "gtest/gtest.h"
#include "../headers/user_input.h"

TEST(OutputTest1, one) {
